...
var nanmaxBy = require( './../lib' ).assign;
...
tape( 'the function performs a reduction on an ndarray (all dimensions, row-major)', function test( t ) {
	...
	actual = nanmaxBy( x, out, opts, clbk );
	expected = 40.0;
